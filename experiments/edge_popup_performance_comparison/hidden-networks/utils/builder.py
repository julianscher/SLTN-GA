# !Modified: Builder.conv() and Builder._init_conv()
...
class Builder(object):
    ...
    def conv(self, kernel_size, in_planes, out_planes, stride=1, first_layer=False):
        ...
        if kernel_size == 3:
            ...
            conv = conv_layer(
                in_planes, out_planes, kernel_size=1, stride=stride, bias=True if args.bias == "True" else False
            )
        elif kernel_size == 5:
            conv = conv_layer(
                in_planes,
    ...
    def _init_conv(self, conv):
        if args.init == "signed_constant":
            ...
            nn.init.uniform_(conv.weight, -1.0, 1.0)
