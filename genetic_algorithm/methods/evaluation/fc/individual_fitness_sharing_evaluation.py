...
class IndividualFitnessSharingEvaluation(IndividualEvaluationMethod):
    ...
    def __init__(self, quality_metric, model=None, train_loader=None, device=None):
        super(IndividualFitnessSharingEvaluation, self).__init__(quality_metric=quality_metric,
