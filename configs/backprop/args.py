...
parser.add_argument(
    ...
    help="When you want to define multiple models"
        ...
        + "criterion: The loss function to use (default: CrossEntropy)"
)
parser.add_argument(
    "--model", default="MLP", help="Used neural network type (default: MLP)"
)
parser.add_argument(
    "--architecture", default=[2, 20, 2], help="Used neural network architecture."
)
parser.add_argument(
...
parser.add_argument(
    "--criterion", default="MSE", type=str, help="The loss function to use (default: CrossEntropy)"
)
parser.add_argument(
...
parser.add_argument(
    "--batch_size", default=128, type=int, help="The batch size for training (default: 128)"
)
parser.add_argument(
...
parser.add_argument(
    "--config", default=None, help="The config file used to configure the run"
)
parser.add_argument(
